 ...
 */
public class ColorButton extends android.support.v7.widget.AppCompatButton implements OnClickListener {
    ...
    public ColorButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        RCCalculator calc = (RCCalculator) context;
        init(calc);
    ...
    private void init(RCCalculator calc) {
